...
public class ClickPriceQuestionButtonTest {
    ...
    public void checkClickPriceQuestion() {
        ...
        boolean isAnswerVisible = new MainPage(driver)
                .clickBtnCookie() // клик по кнопке "Да все привыкли"
                .faqList(question, answer); //поиск нужных вопроса и ответа
